// bpwin.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CBpwinApp, CWinApp)
	//{{AFX_MSG_MAP(CBpwinApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CBpwinApp object

CBpwinApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CBpwinApp initialization

BOOL CBpwinApp::InitInstance()
{
...
\
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CBpwinDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CBpwinView));
...
BOOL CBpwinApp::PreTranslateMessage(MSG* pMsg)
{
